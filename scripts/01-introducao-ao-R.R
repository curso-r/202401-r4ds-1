...
# Podemos acessar algum elemento pela posição!
LETTERS[21]
...
objeto_criado <- 30 #
# É diferente de OBJETO_CRIADO
# letras maiúscula e minúscula são entendidas como coisas diferentes
# case sensitive


# atalho
# <- ALT MENOS/ no mac: OPTION MENOS
...
?mean # busca da documentação pelo nome exato da função

??mean # busca da documentação mas não tenho certeza do nome
